...
from Tsunami_Inundation_Run import Perform_Entire_Inundation
...
with rasterio.open(dem_raster_path) as src:
    ...
    for index, row in gdf.iterrows():
        ...
        #Local_Data_DataFrame.to_csv(f'D:/Nationwide Tsunami Inundation/Inundation_Results/{Region}/{Area}/{Area}_Data.csv', index=False)
